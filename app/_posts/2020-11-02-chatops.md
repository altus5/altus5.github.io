...
ChatOps な社内専用の Chatbot を作るということなら、ただの遊びじゃなく、仕事にも役立ちそうです。  
...
ということで、[npm trends](https://www.npmtrends.com/hubot-vs-botbuilder-vs-rasa-nlu-trainer-vs-botkit-vs-botpress) で比較検索してみました。
