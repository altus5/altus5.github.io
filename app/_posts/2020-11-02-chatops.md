...
ChatOps な社内専用の Chatbot を作るということなら、仕事にも役立ちそうです。  
...
ということで、Chatbot のフレームワークを [npm trends](https://www.npmtrends.com/hubot-vs-botbuilder-vs-rasa-nlu-trainer-vs-botkit-vs-botpress) で比較検索してみました。

![npm trends](/images/blog/chatops/npm-trends.png)

Hubot、BotBuilder というのを見聞きしたことがあったので、そのあたりから、検索してみて、一緒に比較されるパッケージを追加していくと、 BotBuilder が、Download 数が多いことがわかりました。  
...
みなさんも、社内にお助け Chatbot を作ってみませんか？
